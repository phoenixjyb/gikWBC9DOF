...
int main(int, char **)
{
  ...
  main_solveGIKStepWrapper(classInstance);
...
// Return Type  : void
//
void main_solveGIKStepWrapper(gik9dof::GIKSolver *instancePtr)
{
  ...
  // Initialize function 'solveGIKStepWrapper' input arguments.
  // Initialize function input argument 'qCurrent'.
  // Initialize function input argument 'targetPose'.
  // Initialize function input argument 'distBodyIndices'.
  ...
  // Call the entry-point 'solveGIKStepWrapper'.
  argInit_9x1_real_T(dv);
  argInit_4x4_real_T(dv1);
  instancePtr->solveGIKStepWrapper(
