                     ...
                     coder::rigidBodyTree &iobj_3)
{
  ...
  baseX.init(lobj_22[0], lobj_23[0], lobj_24[0], lobj_25[0]);
  baseX.set_Mass();
  ...
  b_robot->get_BaseName(parentName_data, parentName_size);
  b_robot->TreeInternal.addBody(baseX.BodyInternal, parentName_data,
                                parentName_size, (&iobj_0)[0], (&iobj_1)[0],
                                (&iobj_2)[0]);
  //  Joint 2: Prismatic Y (joint_y)
  baseY.b_init(lobj_22[1], lobj_23[1], lobj_24[2], lobj_25[1]);
  baseY.set_Mass();
  ...
  b_robot->addBody(baseY, (&iobj_0)[2], (&iobj_1)[2], (&iobj_2)[1]);
  //  Joint 3: Revolute Theta (joint_theta)
  chassis.c_init(lobj_22[2], lobj_23[2], lobj_24[4], lobj_25[2]);
  chassis.b_set_Mass();
  ...
  jntTheta.b_set_PositionLimits();
  jntTheta.set_HomePosition();
  chassis.BodyInternal->JointInternal = jntTheta.copy(lobj_24[5]);
  b_robot->b_addBody(chassis, (&iobj_0)[4], (&iobj_1)[4], (&iobj_2)[2]);
  //  ARM BASE LINK (fixed mount on chassis)
  armBase.d_init(lobj_22[3], lobj_23[3], lobj_24[6], lobj_25[3]);
  armBase.c_set_Mass();
  ...
  b_robot->c_addBody(armBase, (&iobj_0)[6], (&iobj_1)[6], (&iobj_2)[3]);
  //  ARM JOINT 1 (revolute, Y-axis)
  armLink1.e_init(lobj_22[4], lobj_23[4], lobj_24[8], lobj_25[4]);
  armLink1.d_set_Mass();
  ...
  jntArm1.c_set_PositionLimits();
  jntArm1.set_HomePosition();
  armLink1.BodyInternal->JointInternal = jntArm1.copy(lobj_24[9]);
  b_robot->d_addBody(armLink1, (&iobj_0)[8], (&iobj_1)[8], (&iobj_2)[4]);
  //  ARM JOINT 2 (revolute, -Z-axis)
  armLink2.f_init(lobj_22[5], lobj_23[5], lobj_24[10], lobj_25[5]);
  armLink2.e_set_Mass();
  ...
  jntArm2.d_set_PositionLimits();
  jntArm2.set_HomePosition();
  armLink2.BodyInternal->JointInternal = jntArm2.copy(lobj_24[11]);
  b_robot->e_addBody(armLink2, (&iobj_0)[10], (&iobj_1)[10], (&iobj_2)[5]);
  //  ARM JOINT 3 (revolute, -Z-axis)
  armLink3.g_init(lobj_22[6], lobj_23[6], lobj_24[12], lobj_25[6]);
  armLink3.f_set_Mass();
  ...
  jntArm3.e_set_PositionLimits();
  jntArm3.set_HomePosition();
  armLink3.BodyInternal->JointInternal = jntArm3.copy(lobj_24[13]);
  b_robot->f_addBody(armLink3, (&iobj_0)[12], (&iobj_1)[12], (&iobj_2)[6]);
  //  ARM JOINT 4 (revolute, X-axis)
  armLink4.h_init(lobj_22[7], lobj_23[7], lobj_24[14], lobj_25[7]);
  armLink4.g_set_Mass();
  ...
  jntArm4.c_set_PositionLimits();
  jntArm4.set_HomePosition();
  armLink4.BodyInternal->JointInternal = jntArm4.copy(lobj_24[15]);
  b_robot->g_addBody(armLink4, (&iobj_0)[14], (&iobj_1)[14], (&iobj_2)[7]);
  //  ARM JOINT 5 (revolute, Y-axis)
  armLink5.i_init(lobj_22[8], lobj_23[8], lobj_24[16], lobj_25[8]);
  armLink5.h_set_Mass();
  ...
  jntArm5.f_set_PositionLimits();
  jntArm5.set_HomePosition();
  armLink5.BodyInternal->JointInternal = jntArm5.copy(lobj_24[17]);
  b_robot->h_addBody(armLink5, (&iobj_0)[16], (&iobj_1)[16], (&iobj_2)[8]);
  //  ARM JOINT 6 (revolute, X-axis)
  armLink6.j_init(lobj_22[9], lobj_23[9], lobj_24[18], lobj_25[9]);
  armLink6.i_set_Mass();
  ...
  jntArm6.c_set_PositionLimits();
  jntArm6.set_HomePosition();
  armLink6.BodyInternal->JointInternal = jntArm6.copy(lobj_24[19]);
  b_robot->i_addBody(armLink6, (&iobj_0)[18], (&iobj_1)[18], (&iobj_2)[9]);
  //  END EFFECTOR (fixed gripper link)
  gripper.k_init(lobj_22[10], lobj_23[10], lobj_24[20], lobj_25[10]);
  gripper.j_set_Mass();
  ...
  b_robot->j_addBody(gripper, (&iobj_0)[20], (&iobj_1)[20], (&iobj_2)[10]);
