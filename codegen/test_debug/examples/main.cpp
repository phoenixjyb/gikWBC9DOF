...
#include "gik9dof_planHybridAStarCodegen_terminate.h"
#include "gik9dof_planHybridAStarCodegen_types.h"
#include "rt_nonfinite.h"

// Function Declarations
static void argInit_200x200_boolean_T(boolean_T result[40000]);
...
//
// Arguments    : boolean_T result[40000]
// Return Type  : void
//
static void argInit_200x200_boolean_T(boolean_T result[40000])
{
...
int main(int, char **)
{
  ...
  main_gik9dof_planHybridAStarCodegen();
...
void main_gik9dof_planHybridAStarCodegen()
{
  ...
  gik9dof::planHybridAStarCodegen(&start_state_tmp, &start_state_tmp, &r, path,
                                  &search_stats);
}
