                             ...
                             robotics::manip::internal::RigidBody &iobj_3)
{
  ...
  b_obj.Length = 200.0;
  iobj_3.NameInternal = b_obj;
  b_obj = iobj_3.NameInternal;
  b_obj.Length = 11.0;
  for (i = 0; i < 11; i++) {
    b_obj.Vector[i] = cv8[i];
  }
  iobj_3.NameInternal = b_obj;
  iobj_2.InTree = false;
  for (i = 0; i < 16; i++) {
