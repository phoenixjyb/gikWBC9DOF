//
// File: _coder_solveGIKStepWrapper_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "solveGIKStepWrapper",                                // fFunctionName
                             ...
                             const mxArray *plhs[2])
{
  ...
  distBodyIndices =
      c_emlrt_marshallIn(st, emlrtAlias(prhs[2]), "distBodyIndices");
  distRefBodyIndices =
      c_emlrt_marshallIn(st, emlrtAlias(prhs[3]), "distRefBodyIndices");
  distBoundsLower =
...
void solveGIKStepWrapper_atexit()
{
  ...
  solveGIKStepWrapper_xil_terminate();
  solveGIKStepWrapper_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
//
// File trailer for _coder_solveGIKStepWrapper_api.cpp
//
// [EOF]
//
