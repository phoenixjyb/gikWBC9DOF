...
%% Add paths
% Script is in matlab/ folder, so go up one level to workspace root
addpath(fullfile(pwd, '..'));  % Add workspace root
addpath(fullfile(pwd, '+gik9dof', '+control'));  % Add control functions
...
try
    codegen -config cfg_arm64 holisticVelocityController ...
        -args {refX, refY, refTheta, refTime, estX, estY, estYaw, params, stateIn} ...
        -d codegen/velocity_controller_arm64 -report
...
try
    codegen -config cfg_x64 holisticVelocityController ...
        -args {refX, refY, refTheta, refTime, estX, estY, estYaw, params, stateIn} ...
        -d codegen/velocity_controller_x64 -report
