                                                   ...
                                                   const mxArray *plhs[2])
{
  ...
  gik9dof_codegen_inuse_solveGIKStepWrapper(
      *qCurrent, *targetPose, *distBodyIndices, *distRefBodyIndices,
      *distBoundsLower, *distBoundsUpper, *distWeights, *qNext, &solverInfo);
