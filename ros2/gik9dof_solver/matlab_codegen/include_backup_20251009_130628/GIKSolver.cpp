...
GIKSolver::GIKSolver()
{
  SD_.pd = &pd_;
  omp_init_nest_lock(
      &gik9dof_codegen_realtime_solveGIKStepWrapper_nestLockGlobal);
...
//
// Arguments    : void
// Return Type  : gik9dof_codegen_realtime_solveGIKStepWrapperStackData *
//
gik9dof_codegen_realtime_solveGIKStepWrapperStackData *GIKSolver::getStackData()
{
  return &SD_;
}
...
// Return Type  : void
//
void GIKSolver::gik9dof_codegen_realtime_solveGIKStepWrapper(
