...
namespace coder {
static int bsearchni(int k, const array<double, 1U> &x, const double s[24]);
...
void isMember(const array<double, 1U> &a, const double s[24],
              array<bool, 1U> &tf, array<int, 1U> &loc)
{
  double ss[24];
  int k;
  int n;
