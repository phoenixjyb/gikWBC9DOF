//
// File: _coder_planHybridAStarCodegen_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "planHybridAStarCodegen",                             // fFunctionName
                                ...
                                const mxArray *plhs[2])
{
  ...
  planHybridAStarCodegen(&start_state, &goal_state, &occupancy_grid, path,
                         &search_stats);
...
void planHybridAStarCodegen_atexit()
{
  ...
  planHybridAStarCodegen_xil_terminate();
  planHybridAStarCodegen_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
//
// File trailer for _coder_planHybridAStarCodegen_api.cpp
//
// [EOF]
//
